...
import { getAddress, saveAddress, updateAddress } from "../../services/localstorage-service";
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              <Switch
                ...
                onChange={(e) =>
                  setAddressForm({ ...addressForm, isDefault: e })
                }
                className={classNames(
                  addressForm.isDefault ? "bg-cyan-800" : "bg-gray-700",
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className={classNames(
                    addressForm.isDefault ? "translate-x-3.5" : "translate-x-0",
