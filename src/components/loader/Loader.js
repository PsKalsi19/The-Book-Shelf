...
const Loader = () => {
    return (
        <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-gray-950 opacity-90 flex flex-col items-center justify-center">
            ...
            <div className="preloader__text text-center">
                <p className="preloader__msg text-gray-100">Bringing you the Goods.</p>
                <p className="preloader__msg preloader__msg--last text-gray-100">Conjuring the Literary Wonders.</p>
            </div>
                </div>
        </div>
    );
